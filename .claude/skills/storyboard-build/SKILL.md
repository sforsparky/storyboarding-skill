...
## Steps
1. Read `projects/<name>/script.md` and the project's brand at `brands/<brand>/storyboard-brand.json`.
...
6. Emit `projects/<name>/storyboard-build.json` with the schema below. Keep row `id` stable across
