...
## Push
`scripts/sheets_sync.py push projects/<name>/storyboard-build.json`
...
- Writes `▶ SECTION` header rows, applies the legend colors to the Visual column, sets Status
  data-validation (Draft/Generating/Generated/Approved/Reshoot).
...
## Pull feedback
`scripts/sheets_sync.py pull projects/<name>/storyboard-build.json`
